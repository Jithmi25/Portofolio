...
const WORDS = ["IS Undergraduate", "Tech Enthusiast", "Aspiring Project Manager", "Lifelong Learner"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Jithmi25" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/jithmi-wickramasinghe" }
];
